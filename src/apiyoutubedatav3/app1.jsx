...
export function App1() {
  ...
  const [idchannel,setIdchannel] = useState("UCKnTtZpgQiIznMU3tl40DjQ")
  ...
  const handleIncrement= async () => {
    ...
    const solicitudinfocanal =`https://youtube.googleapis.com/youtube/v3/channels?part=snippet,brandingSettings&id=${idchannel}&key=AIzaSyB02E8Ki_FkLbuv3TJ84OfEW_X6In2ZCPk`
    ...
    const solicitudinfoseccionescanal= `https://youtube.googleapis.com/youtube/v3/channelSections?part=snippet,contentDetails&fields=items(snippet.title,contentDetails.playlists)&channelId=${idchannel}&key=AIzaSyB02E8Ki_FkLbuv3TJ84OfEW_X6In2ZCPk`
  ...
  return (
    ...
    <div className="head">
    <a className="enlace" target="_BLANK" href="https://barrazacarlos.com/free-seo-tools/es/youtube-channel-id" >enlace para obtener el id de cualquier canal</a><br />
    <input placeholder='id del canal' className="entrada form-control" type="text" onChange={e=>setIdchannel(e.target.value)} />
